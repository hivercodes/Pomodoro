...
def start_timer():
    ...
    if reps % 8 == 0:
        ...
        timer_title.config(text="Long Rest", fg=GREEN)
    elif reps % 2 == 0:
        count_down(short_break_sec)
        timer_title.config(text="Rest", fg=GREEN)
    else:
        count_down(work_sec)
...
check_box = Label(fg=GREEN, font=(FONT_NAME, 30, "bold" ))
